...
# wrap-c.py:
#
# A wrapper around clang, to get LLVM IR. When you use clang to get the IR not object files
# are created. Thus, we should invoke clang once to get the IR and one more time to compile
# the file (otherwise make fails).
#
# To compile library with this compiler, configure it as follows:
#
#       CC=./wrap-c.py CXX=./wrap-c++.py ./configure
#
# -------------------------------------------------------------------------------------------------
import sys
import os
