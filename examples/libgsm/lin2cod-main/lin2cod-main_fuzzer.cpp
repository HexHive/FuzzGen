...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    /* * * function pool #1 * * */
    //{
        // initializing argument 'val_mRz'
        int32_t val_mRz_0 = 0;
        int32_t *val_mRz_1 = &val_mRz_0;

        gsm_option(dep_6, 1, val_mRz_1); /* vertex #1 */
    ...
    /* * * function pool #2 * * */
    //{
        // initializing argument 'val_AVt'
        int32_t val_AVt_0 = 0;
        int32_t *val_AVt_1 = &val_AVt_0;

        gsm_option(dep_6, 2, val_AVt_1); /* vertex #6 */
    ...
    /* * * function pool #3 * * */
    //{
        // initializing argument 'val_FCf'
        int32_t val_FCf_0 = 0;
        int32_t *val_FCf_1 = &val_FCf_0;

        gsm_option(dep_6, 4, val_FCf_1); /* vertex #7 */
    ...
    /* * * function pool #4 * * */
    //{
        // initializing argument 'source_eGE'
        for (uint64_t i_0=0; i_0<160; ++i_0) {
            source_eGE[i_0] = E.eat2();
        }

        // Dependence family #4 Definition
        dep_4 = (int16_t *)&source_eGE;
        // initializing argument 'c_Oxg'
        ...
        dep_3 = (uint8_t *)&c_Oxg;
        gsm_encode(dep_6, (int16_t *)dep_4, (uint8_t *)dep_3); /* vertex #4 */
    ...
    /* * * function pool #5 * * */
    //{
        gsm_explode(dep_6, (uint8_t *)dep_3, (int16_t *)dep_4); /* vertex #8 */
