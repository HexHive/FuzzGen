...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    /* * * function pool #1 * * */
    //{
        // initializing argument 'val_BNf'
        int32_t val_BNf_0 = 0;
        int32_t *val_BNf_1 = &val_BNf_0;

        gsm_option(dep_7, 1, val_BNf_1); /* vertex #1 */
