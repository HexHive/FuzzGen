 ...
 *
 * Issues: 
 *   > Backward Slicing on vertex #6 failed.
 *   > Backward Slicing on vertex #13 failed.
 *   > AADG node #6 has no APICall object.
 *   > AADG node #13 has no APICall object.
 *
 *
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    /* * * function pool #1 * * */
    //{
        // initializing argument 'val_caK'
        int32_t val_caK_0 = 0;
        int32_t *val_caK_1 = &val_caK_0;

        gsm_option(dep_6, 1, val_caK_1); /* vertex #1 */
    ...
    /* * * function pool #2 * * */
    //{
        // initializing argument 'val_UJu'
        int32_t val_UJu_0 = 0;
        int32_t *val_UJu_1 = &val_UJu_0;

        gsm_option(dep_6, 2, val_UJu_1); /* vertex #6 */
    ...
    /* * * function pool #3 * * */
    //{
        // initializing argument 'val_Tqd'
        int32_t val_Tqd_0 = 0;
        int32_t *val_Tqd_1 = &val_Tqd_0;

        gsm_option(dep_6, 4, val_Tqd_1); /* vertex #7 */
    ...
    /* * * function pool #4 * * */
    //{
        // initializing argument 'source_FZP'
        for (uint64_t i_0=0; i_0<160; ++i_0) {
            source_FZP[i_0] = E.eat2();
        }

        // Dependence family #4 Definition
        dep_4 = (int16_t *)&source_FZP;
        // initializing argument 'c_xNr'
        ...
        dep_3 = (uint8_t *)&c_xNr;
        gsm_implode(dep_6, (int16_t *)dep_4, (uint8_t *)dep_3); /* vertex #4 */
    ...
    /* * * function pool #5 * * */
    //{
        gsm_decode(dep_6, (uint8_t *)dep_3, (int16_t *)dep_4); /* vertex #8 */
